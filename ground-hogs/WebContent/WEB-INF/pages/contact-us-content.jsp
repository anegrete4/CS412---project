...
<div class="wrapper">
   <div class="parallex" id="contactUs">
      <div class="parallexContaint">
         ...
         <a href="#CustomerSupport" class="DownArrow nextSection"></a>
      </div>
   </div>
  
			
   <div class="row" id="CustomerSupport">
			<div class="column">
			...
			<div class="column"> 
				<a><img src="images/customerSupport.jpg" alt="Customer Support Image"></a>
			</div>
 </div>
 <div class="row" id="bestRow">
			<div id="best"><h1>Meet Us</h1></div>
