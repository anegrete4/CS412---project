...
<div class="wrapper">
   ...
   <div id="ContentBody">
         ...
         <div class="Content-panel">
            ...
            <div class="Content-panel-content" id="BusinessInfo">
            	<h3>Meet Us</h3>
	            <p>5600 N. St. Louis. Ave Chicago IL-60625
	               <br>phone: 323-946-6532
	               <br> email: office@ggg.com
	               <br>Monday-Friday:7:00AM - 8:00PM
	             </p>
	            </div>
             <a class="PanelButton" href="http://www.google.com/maps/place/5600+N.+St.+Louis+Ave+Chicago+IL+60625">Get Directions</a>
         </div>
         <div class="Content-panel">
