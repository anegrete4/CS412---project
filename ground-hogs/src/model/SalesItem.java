...
public class SalesItem {
	...
	public String createHtmlAnchor(String anchorName) {
		...
		return "<a href='http://localhost:8080/ground-hogs/popUpDisplay.do?popUpTitle=" + itemName
				+ "&popUpContent=popUpSalesItem&itemId=" + itemId + "'>" + anchorName + "</a>";
		/*
		 * String htmlString=
		 ...
		 * "</form>"; return htmlString;
		 */
	}

	public String createHtmlAnchorHref() {
		return "http://localhost:8080/ground-hogs/popUpDisplay.do?popUpTitle=" + itemName
				+ "&popUpContent=popUpSalesItem&itemId=" + itemId;
